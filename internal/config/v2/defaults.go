...
func defaultServiceMap(clusterFQDN string) ServiceMap {
	return ServiceMap{
		...
		"loki":                  &services.LokiConfig{BaseConfig: services.BaseConfig{Enabled: true, Namespace: "observability", SourceName: "opencenter-observability", OverrideValuesRendererKey: "loki", ExtraDependencies: []string{"loki-override"}, OverrideDependsOn: []string{"sources"}}},
		...
		"tempo":                 &services.TempoConfig{BaseConfig: services.BaseConfig{Enabled: true, Namespace: "observability", SourceName: "opencenter-observability", OverrideValuesRendererKey: "tempo", ExtraDependencies: []string{"tempo-override"}, OverrideDependsOn: []string{"sources"}}},
